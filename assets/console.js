...
console.log('%cHello.', 'background-color: rgb(191, 223, 144); font-size: 3rem; padding:10px;')
console.log(`%cI'm Nicholas LaMonaco`, 'background-color: rgb(191, 223, 144); font-size: 1.5rem; padding:5px;')
console.log(`%cAn aspiring full-stack web developer from New Jersey.`, 'background-color: rgb(191, 223, 144); font-size: 1rem; padding:5px;')
console.log(`%c${email} nlamonaco86@gmail.com`, `background-color: rgb(191, 223, 144); font-size: 1rem; padding:5px;`)
console.log(`%c${phone} 908-337-9307`, `background-color: rgb(191, 223, 144); font-size: 1rem; padding:5px;`)
...
console.log(`%cDon't Say Goodbye!`, 'background-color: rgb(191, 223, 144); font-size: 2rem; padding:10px;')
console.log(`%c${email} nlamonaco86@gmail.com`, `background-color: rgb(191, 223, 144); font-size: 1rem; padding:5px;`)
console.log(`%c${phone} 908-337-9307`, `background-color: rgb(191, 223, 144); font-size: 1rem; padding:5px;`)