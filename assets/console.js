...
console.log(`%chttp://repairtracker.herokuapp.com`, 'font-size: 1rem;')
console.log(`%chttps://guarded-hamlet-46204.herokuapp.com/`, 'font-size: 1rem;')
console.log(`%chttps://fullstackfitness.herokuapp.com/`, 'font-size: 1rem;')
console.log(`%cDon't Say Goodbye!`, 'background-color: rgb(191, 223, 144); font-size: 3rem;')
